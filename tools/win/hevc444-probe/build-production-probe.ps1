...
try {
    ...
    & cl /nologo /EHsc /std:c++17 /MT /O2 /utf-8 "/Fo:$output/" "/Fe:$output/production-backend-probe.exe" src/backend_win/vm_video_decode_d3d12.cpp tools/win/hevc444-probe/production-backend-probe.cpp "$output/vm_video_decode.obj" /link d3d11.lib d3d12.lib dxgi.lib dxguid.lib mf.lib mfplat.lib mfuuid.lib ole32.lib user32.lib
