 ...
 *     systemd/
 *       appsandbox-{agent,audio,clipboard,display,input,display-helper}.service
 *       (appsandbox-firstboot.service is generated by ubuntu_vhdx.c, the
 *        single source of truth for the Ubuntu firstboot unit.)
